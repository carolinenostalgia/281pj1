...
void stackSearch(vector<string>& originalMap, int current_room, int current_i, int current_j, int n, int roomNum, vector<int> startPos){
    ...
    vector<int> b = {};
    vector<int> finalPos = {};
    myDeque.push_front({current_i, current_j, current_room});// push_back the staPos
    ...
    while (!myDeque.empty()) {
        ...
        if(current_i - 1 >= 0){
            ...
            if(myMap[3 + current_room * n + current_i - 1][current_j] == '.'){
                myDeque.push_front({current_i - 1, current_j, current_room});
                ...
                myDeque.push_front({current_i - 1, current_j, cr});
                myMap[3 + current_room * n + current_i - 1][current_j] = 'V';
        ...
        if(current_j + 1 <= n - 1){
            ...
            if(myMap[3 + current_room * n + current_i][current_j + 1] == '.'){
                myDeque.push_front({current_i, current_j + 1, current_room});
            ...
            else if(isdigit(myMap[3 + current_room * n + current_i][current_j+1]))
            {
                ...
                myDeque.push_front({current_i, current_j+1, cr});
                myMap[3 + current_room * n + current_i][current_j+1] = 'V';
